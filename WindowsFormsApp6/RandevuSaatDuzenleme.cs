...
{
    public partial class RandevuSaatDuzenleme : MetroForm
    {
        List<Appointment> m_Appointments;
        public RandevuSaatDuzenleme(DateTime date, int ID)
        {
            InitializeComponent();
        ...
        private void metroButton1_Click(object sender, EventArgs e)
        {
            ...
            if (result == System.Windows.Forms.DialogResult.Yes)
            {
                ...
                RandevuDuzenle.Seans1.seansBaslangicTarihi = Convert.ToDateTime(metroLabel3.Text);
                RandevuDuzenle.Seans1.seansBitisTarihi = Convert.ToDateTime(metroLabel4.Text);
                RandevuDuzenle.Seans1.isChooseSeansTime = true;
                RandevuDuzenle.label.Text += "+";
                this.Close();
            }
