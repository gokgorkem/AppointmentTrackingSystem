...
namespace Opulos.Core.UI
{
    ...
    public class Accordion : UserControl, IMessageFilter
    {
        ...
        ///<summary>The factory used to create a header CheckBoxCustom when a control is added to an Accordion.
        ...
        ///<para>Use the Count property &amp; Control(i), CheckBoxCustom(i), ResizeBar(i) methods to access the controls.</para>
        ...
        public class AddArgs
        {
            ...
            public CheckBoxCustom CheckBoxCustom { get; internal set; }
        }
        ...
        ///<summary>Adds a control to this accordion. A header CheckBoxCustom is displayed above the control with the specified text.</summary>
        ...
        ///<returns>Returns the CheckBoxCustom header created by the CheckBoxFactory.</returns>
        public CheckBoxCustom Add(Control c, String text, String toolTip = null, double fillWt = 0, bool? open = null, Padding? contentPadding = null, Padding? contentMargin = null, Color? contentBackColor = null, Padding? checkboxMargin = null, bool? addResizeBar = null, Padding? resizeBarMargin = null, LayoutArgs layoutArgs = null)
        {
        ...
        public void Clear()
        {
            ...
            for (int i = Controls.Count - 1; i >= 0; i--)
            {
                ...
                Controls.RemoveAt(i);
                c.Dispose(); // could be resize bar, Control2 or CheckBoxCustom
            }
        ...
        private static void _MouseEnter(object sender, EventArgs e)
        {
            if (sender is CheckBoxCustom)
            {
                CheckBoxCustom a = (CheckBoxCustom)sender;
                Color c = a.BackColor;
                a.BackColor = a.ForeColor;
                a.ForeColor = c;
            }
        }
        private static void _MouseLeave(object sender, EventArgs e)
        {
            if (sender is CheckBoxCustom)
            {
                CheckBoxCustom a = (CheckBoxCustom)sender;
        ...
        public CheckBoxCustom Add(AddArgs args)
        {
            args.Owner = this;
            Control c = args.c;
            ...
            CheckBoxCustom cb = cbf.CreateCheckBox(args.text, check, Get(checkboxMargin, CheckBoxMargin));
            cb.MouseEnter += new EventHandler(_MouseEnter);
            cb.MouseLeave += new EventHandler(_MouseLeave);
            cb.TextAlign = ContentAlignment.MiddleLeft;
            args.CheckBoxCustom = cb;
        ...
        ///</summary>
        public virtual void SetCheckBoxText(CheckBoxCustom cb, String text)
        {
        ...
        ///<summary>Returns the n'th CheckBoxCustom header.</summary>
        public CheckBoxCustom CheckBoxCustom(int i)
        {
        ...
        ///<summary>Finds the header CheckBoxCustom for the specified control. This can be useful
        ...
        public CheckBoxCustom CheckBoxForControl(Control c)
        {
            c = c.Parent;
            while (c != null)
            {
            ...
            //	CheckBoxCustom cb = acc.CheckBoxCustom(i);
        ...
        private class Control2 : UserControl
        {
            ...
            public Control2(CheckBoxCustom cb, Control c, Control resizeBar, double fillWt, LayoutArgs layoutArgs, Padding c2Padding, Padding c2Margin)
            {
                this.cb = cb;
                this.c = c;
                this.fillWt = fillWt;
        ...
        {
            CheckBoxCustom CreateCheckBox(String text, bool check, Padding margin);
        }
        ...
        {
            public virtual CheckBoxCustom CreateCheckBox(String text, bool check, Padding margin)
            {
                CheckBoxCustom cb = new CheckBoxCustom();
                cb.Appearance = Appearance.Button;
                cb.AutoSize = true; // AutoSize must be true or the text will wrap under and be hidden
                cb.Checked = check;
                cb.Text = text;
                cb.Anchor = AnchorStyles.Left | AnchorStyles.Right; // ac/cb.Dock = DockStyle.Fill;// also works.
